...
\input{sponsorentexte/202-mundialis.tex}
...
{%
  ...
  \begin{itemize}
    ...
    \item \emph{Stefan Eberlein}: OSM-Extrakte als Service in nahezu "`Real-Time"'
    \item \emph{Julian Psotta}: Mit Openrouteservice ganze Länder vermeiden für die Routenplanung
    \item \emph{Marcel Belledin}: Luftdaten für die Stadt -- OpenAir Cologne
  \end{itemize}

  \noindent Bitte beachten Sie auch die Aushänge.
}
...
\input{sponsorentexte/203-geoinformatik-buero-dassau.tex}
...
\input{sponsorentexte/207-geosys.tex}
...
\input{sponsorentexte/205-mapwebbing.tex}
...
\input{sponsorentexte/206-52n.tex}
...
\vfill
\input{sponsorentexte/210-latlon.tex}
\vfill
\vfill
...
\input{sponsorentexte/208-gkg-kassel.tex}
...
\vfill
\input{sponsorentexte/209-kuestenschmiede.tex}
\vfill
